    ...
    <header className="bg-gray-950 text-white sticky top-0 z-50 shadow-2xl">
      ...
      <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href={PHONE_HREF}
            className="inline-flex items-center gap-1.5 bg-orange-500 hover:bg-orange-600 active:scale-95 text-white font-black px-3 py-2 sm:px-4 sm:py-2.5 rounded-lg shadow-lg transition-all focus:outline-none focus:ring-2 focus:ring-orange-300 text-sm sm:text-base"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0">
